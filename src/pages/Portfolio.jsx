...
const projects = [
  // Development Projects
  {
    ...
    type: 'Front-end Development, UX/UI Design',
  ...
  },
  {
    ...
    type: 'Front and Back-end Development, UX/UI Design',
    category: ['Development', 'UX/UI Design'],
    cta: 'See More',
  ...
  },
  {
    ...
    type: 'Front and Back-end Development',
    category: 'Development',
    cta: 'See More',
  ...
  {
    title: 'FuncTastic: JavaScript function checklist and tracker for developers to manage and monitor function details within a project.',
  ...
  {
    title: 'Norseman Nuptials: Creating a brand identity and collateral for couples seeking non-traditional wedding experiences that increased engagement and bookings.',
    link: 'https://cheyennaraelynn.myportfolio.com/branding-norseman-nuptials',
    type: 'Branding, Marketing, Digital, Print, Social Media',
    category: 'Graphic Design',
    cta: 'See More',
    image: NorsemanNuptialsImg,
  },
  {
    title: 'Ocha Tea House: Developing a unique brand identity and collateral for a Japanese tea house that increased foot traffic and sales by blending tradition with modern appeal.',
  ...
  {
    title: 'North Woods Beverage Co: Creating seasonal label designs that captured the adventurous spirit of cold brew coffee and increased sales by 25%.',
  ...
  {
    title: 'SecureWorld: Designing an EDM-inspired conference theme that increased attendee engagement by 50% and enhanced the event experience.',
  ...
  {
    title: 'SecureWorld: Modernizing a brand identity across print digital and multimedia platforms resulting in a 60% increase in engagement.',
    link: 'https://cheyennaraelynn.myportfolio.com/branding-marketing-secureworld',
    type: 'Web, Branding, Marketing, Digital, Print, Social Media, Motion, Infographics',
    category: 'Graphic Design',
    cta: 'See More',
    image: SecureWorldCollateralImg,
  },
  {
    title: 'Swanky: Increasing engagement through targeted social media outreach email blasts and rebranding technical documents for improved community connection.',
  ...
  {
    title: 'Politos Pizza: Rebranding to increase brand awareness and attract new customers with a refreshed logo and engaging collateral.',
